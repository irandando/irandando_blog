 ...
 * handled by a callback to dazzling_comment() which is
...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		<h3 class="comments-title">
			<?php
				printf( _nx( 'Un comentario en &ldquo;%2$s&rdquo;', '%1$s comentarios en &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'dazzling' ),
